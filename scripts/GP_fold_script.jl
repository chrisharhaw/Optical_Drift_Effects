# scripts/GP_fold_script.jl

# Display the lensing by a general fold as defined in Gaudi, Petters 2002
...
p_overlay = plot(p_lens, p_src; layout=(1,2), title="GP fold a=$(a), b=$(b), c=$(c), d=$(d)", size=(1600, 800), left_margin=12Plots.mm, right_margin=6Plots.mm,
    top_margin=6Plots.mm,   bottom_margin=12Plots.mm)

savefig(p_overlay, "GP_fold_a=$(a)_b=$(b)_c=$(c).png")
println("Saved: GP_fold_a=$(a)_b=$(b)_c=$(c).png")
